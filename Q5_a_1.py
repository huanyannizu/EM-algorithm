...
# save('likelihood/Q5/a/LM_GMM_train.npy', likelihood_train_mm)
# save('likelihood/Q5/a/LM_GMM_val.npy', likelihood_val_mm)
# save('likelihood/Q5/a/LM_LM_train.npy', likelihood_train_lm)
# save('likelihood/Q5/a/LM_LM_val.npy', likelihood_val_lm)

pd.DataFrame(likelihood_train_mm).to_csv('/Users/lixinyue/Documents/Machine_Learning_Advanced_Probabilistic_Methods/example_code_python_change/LM_GMM_train_average.csv', header = None, index = None)
pd.DataFrame(likelihood_val_mm).to_csv('/Users/lixinyue/Documents/Machine_Learning_Advanced_Probabilistic_Methods/example_code_python_change/LM_GMM_val_average.csv', header = None, index = None)
pd.DataFrame(likelihood_train_lm).to_csv('/Users/lixinyue/Documents/Machine_Learning_Advanced_Probabilistic_Methods/example_code_python_change/LM_LM_train_average.csv', header = None, index = None)
pd.DataFrame(likelihood_val_lm).to_csv('/Users/lixinyue/Documents/Machine_Learning_Advanced_Probabilistic_Methods/example_code_python_change/LM_LM_val_average.csv', header = None, index = None)
